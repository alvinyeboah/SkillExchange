  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-background">
      ...
      >
        ...
        <p className="text-xl mb-8">Create an account to start trading skills and earning SkillCoins!</p>
        ...
        <Card className="w-full max-w-md">
          <CardHeader>
            <div className="flex justify-between items-center">
              ...
              <ThemeToggle />            </div>
            <CardDescription>Join SkillExchange and start your journey</CardDescription>
          </CardHeader>
          <CardContent>
